...
<h2>1. Fecha actual en castellano</h2>
<p>
<?php
...
<h2>2. Introduce un número para verificar suma de dígitos = producto de dígitos</h2>
<form method="post">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['checkSumaProd']) && isset($_POST['numSumaProd'])) {
    $numSP = intval($_POST['numSumaProd']);
    $resultadoSP = sumaProductoIgual($numSP) ? "Cumple" : "No cumple";
...
<h2>3 & 4. Introduce un número para calcular factorial y comprobar si es primo</h2>
<form method="post">
